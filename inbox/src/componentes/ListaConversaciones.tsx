  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div ref={contenedor} className="flex-1 overflow-y-auto">
        {filtradas.length === 0 ? (
          // Con búsqueda NO se dice «sin resultados» a secas: puede que no
          // haya conversaciones que casen y sí mensajes, que van justo
        ...
        {/*
          Y DEBAJO, lo que se encontró DENTRO de los mensajes.

          Va dentro del mismo contenedor con scroll para que se llegue a ello
          bajando, como en WhatsApp. Pregunta al servidor, así que alcanza los
